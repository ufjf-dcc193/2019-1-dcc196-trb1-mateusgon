...
<head>
  ...
  <title>Acompanhamento e gestão de ONGs</title>
  ...
  <link rel="styleSheet" type="text/css" href="/css/coverAtividadeMembro.css">

</head>

<body class="text-center" background="http://soupetropolis.com/wp-content/uploads/2018/01/IMG_0872-1024x768.jpg"
  style="background-repeat: no-repeat; background-size: 100%; height: 100vh;">
  ...
  <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    <header class="masthead mb-auto">
      <div class="inner">
        <a href="/index">
          <h3 class="masthead-brand">Gestão de ONGs</h3>
        </a>
